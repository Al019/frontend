    ...
    <>
      <div className='space-y-6'>
        {!request.payment && (
          <div className='flex justify-end'>
            <Btn label="Confirm" onClick={handleOpen} size="sm" color='blue' className={request.request_status === 'cancel' && 'hidden'} />
          </div>
        )}
      ...
      <Dialog size='xs' open={open} dismiss={false}>
        ...
        <DialogBody className='space-y-6'>
          <p className='text-sm font-normal text-gray-800'>Please enter the OR Number</p>
          <Inpt value={formattedOrNumber} onChange={(e) => ORNumber(e)} label='OR Number' />
        </DialogBody>
      ...
      <Dialog size='xs' open={isOpen} dismiss={false}>
        ...
        <DialogBody className='space-y-6'>
          ...
          <div className='space-y-2'>
            <p className='font-normal text-gray-800 text-sm'>Kindly double-check the OR Number for accuracy.</p>
            <p className='font-medium text-gray-800 text-base'>{formattedOrNumber}</p>
          </div>
        </DialogBody>
        <DialogFooter className="space-x-3">
